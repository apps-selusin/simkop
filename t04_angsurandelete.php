...
ft04_angsurandelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($t04_angsuran->AngsuranPokok->Visible) { // AngsuranPokok ?>
		<th class="<?php echo $t04_angsuran->AngsuranPokok->HeaderCellClass() ?>"><span id="elh_t04_angsuran_AngsuranPokok" class="t04_angsuran_AngsuranPokok"><?php echo $t04_angsuran->AngsuranPokok->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->AngsuranBunga->Visible) { // AngsuranBunga ?>
		<th class="<?php echo $t04_angsuran->AngsuranBunga->HeaderCellClass() ?>"><span id="elh_t04_angsuran_AngsuranBunga" class="t04_angsuran_AngsuranBunga"><?php echo $t04_angsuran->AngsuranBunga->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->AngsuranTotal->Visible) { // AngsuranTotal ?>
		<th class="<?php echo $t04_angsuran->AngsuranTotal->HeaderCellClass() ?>"><span id="elh_t04_angsuran_AngsuranTotal" class="t04_angsuran_AngsuranTotal"><?php echo $t04_angsuran->AngsuranTotal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->SisaHutang->Visible) { // SisaHutang ?>
		<th class="<?php echo $t04_angsuran->SisaHutang->HeaderCellClass() ?>"><span id="elh_t04_angsuran_SisaHutang" class="t04_angsuran_SisaHutang"><?php echo $t04_angsuran->SisaHutang->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->TanggalBayar->Visible) { // TanggalBayar ?>
		<th class="<?php echo $t04_angsuran->TanggalBayar->HeaderCellClass() ?>"><span id="elh_t04_angsuran_TanggalBayar" class="t04_angsuran_TanggalBayar"><?php echo $t04_angsuran->TanggalBayar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->TotalDenda->Visible) { // TotalDenda ?>
		<th class="<?php echo $t04_angsuran->TotalDenda->HeaderCellClass() ?>"><span id="elh_t04_angsuran_TotalDenda" class="t04_angsuran_TotalDenda"><?php echo $t04_angsuran->TotalDenda->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->Terlambat->Visible) { // Terlambat ?>
		<th class="<?php echo $t04_angsuran->Terlambat->HeaderCellClass() ?>"><span id="elh_t04_angsuran_Terlambat" class="t04_angsuran_Terlambat"><?php echo $t04_angsuran->Terlambat->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t04_angsuran->Keterangan->Visible) { // Keterangan ?>
		<th class="<?php echo $t04_angsuran->Keterangan->HeaderCellClass() ?>"><span id="elh_t04_angsuran_Keterangan" class="t04_angsuran_Keterangan"><?php echo $t04_angsuran->Keterangan->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
