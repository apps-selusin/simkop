...
ft96_employeesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($t96_employees_view->Pager)) $t96_employees_view->Pager = new cPrevNextPager($t96_employees_view->StartRec, $t96_employees_view->DisplayRecs, $t96_employees_view->TotalRecs, $t96_employees_view->AutoHidePager) ?>
...
<?php if ($t96_employees->FirstName->Visible) { // FirstName ?>
	<tr id="r_FirstName">
		<td class="col-sm-2"><span id="elh_t96_employees_FirstName"><?php echo $t96_employees->FirstName->FldCaption() ?></span></td>
...
<?php if ($t96_employees->Username->Visible) { // Username ?>
	<tr id="r_Username">
		<td class="col-sm-2"><span id="elh_t96_employees_Username"><?php echo $t96_employees->Username->FldCaption() ?></span></td>
