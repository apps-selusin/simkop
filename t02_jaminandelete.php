...
<?php if ($t02_jaminan->nasabah_id->Visible) { // nasabah_id ?>
		<th class="<?php echo $t02_jaminan->nasabah_id->HeaderCellClass() ?>"><span id="elh_t02_jaminan_nasabah_id" class="t02_jaminan_nasabah_id"><?php echo $t02_jaminan->nasabah_id->FldCaption() ?></span></th>
<?php } ?>
