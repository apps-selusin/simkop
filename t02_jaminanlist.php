...
?>
<?php
if ($t02_jaminan_list->DbMasterFilter <> "" && $t02_jaminan->getCurrentMasterTable() == "t03_pinjaman") {
	if ($t02_jaminan_list->MasterRecordExists) {
?>
...
<?php } ?>
<?php if ($t02_jaminan->getCurrentMasterTable() == "t03_pinjaman" && $t02_jaminan->CurrentAction <> "") { ?>
...
<?php if ($t02_jaminan->nasabah_id->Visible) { // nasabah_id ?>
	...
	<?php } else { ?>
		<th data-name="nasabah_id" class="<?php echo $t02_jaminan->nasabah_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->nasabah_id) ?>',2);"><div id="elh_t02_jaminan_nasabah_id" class="t02_jaminan_nasabah_id">
