...
$t02_angsuran_grid = NULL; // Initialize page object first

class ct02_angsuran_grid extends ct02_angsuran {
	...
	// Page object name
	var $PageObjName = 't02_angsuran_grid';

	// Grid form hidden field names
	var $FormName = 'ft02_angsurangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t02_angsuran"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderRow() {
		...
		$this->Terlambat->ViewCustomAttributes = "";
			...
			$this->AngsuranPokok->EditValue = ew_FormatNumber($this->AngsuranPokok->EditValue, -2, -1, -2, 0);
			...
			$this->AngsuranBunga->EditValue = ew_FormatNumber($this->AngsuranBunga->EditValue, -2, -1, -2, 0);
			...
			$this->AngsuranTotal->EditValue = ew_FormatNumber($this->AngsuranTotal->EditValue, -2, -1, -2, 0);
			...
			$this->SisaHutang->EditValue = ew_FormatNumber($this->SisaHutang->EditValue, -2, -1, -2, 0);
			...
			$this->TotalDenda->EditValue = ew_FormatNumber($this->TotalDenda->EditValue, -2, -1, -2, 0);
