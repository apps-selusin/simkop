...
ft99_audittraildelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($t99_audittrail->id->Visible) { // id ?>
		<th class="<?php echo $t99_audittrail->id->HeaderCellClass() ?>"><span id="elh_t99_audittrail_id" class="t99_audittrail_id"><?php echo $t99_audittrail->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->datetime->Visible) { // datetime ?>
		<th class="<?php echo $t99_audittrail->datetime->HeaderCellClass() ?>"><span id="elh_t99_audittrail_datetime" class="t99_audittrail_datetime"><?php echo $t99_audittrail->datetime->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->script->Visible) { // script ?>
		<th class="<?php echo $t99_audittrail->script->HeaderCellClass() ?>"><span id="elh_t99_audittrail_script" class="t99_audittrail_script"><?php echo $t99_audittrail->script->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->user->Visible) { // user ?>
		<th class="<?php echo $t99_audittrail->user->HeaderCellClass() ?>"><span id="elh_t99_audittrail_user" class="t99_audittrail_user"><?php echo $t99_audittrail->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->action->Visible) { // action ?>
		<th class="<?php echo $t99_audittrail->action->HeaderCellClass() ?>"><span id="elh_t99_audittrail_action" class="t99_audittrail_action"><?php echo $t99_audittrail->action->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->_table->Visible) { // table ?>
		<th class="<?php echo $t99_audittrail->_table->HeaderCellClass() ?>"><span id="elh_t99_audittrail__table" class="t99_audittrail__table"><?php echo $t99_audittrail->_table->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t99_audittrail->_field->Visible) { // field ?>
		<th class="<?php echo $t99_audittrail->_field->HeaderCellClass() ?>"><span id="elh_t99_audittrail__field" class="t99_audittrail__field"><?php echo $t99_audittrail->_field->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
