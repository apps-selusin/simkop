...
ft06_pinjamantitipangrid.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
if ($t06_pinjamantitipan->CurrentAction == "gridadd") {
	if ($t06_pinjamantitipan->CurrentMode == "copy") {
		...
		if ($bSelectLimit) {
			$t06_pinjamantitipan_grid->TotalRecs = $t06_pinjamantitipan->ListRecordCount();
	...
	if ($t06_pinjamantitipan->CurrentAction == "" && $t06_pinjamantitipan_grid->TotalRecs == 0) {
		if (!$Security->CanList())
			$t06_pinjamantitipan_grid->setWarningMessage(ew_DeniedMsg());
...
<div class="box ewBox ewGrid<?php if ($t06_pinjamantitipan_grid->IsAddOrEdit()) { ?> ewGridAddEdit<?php } ?> t06_pinjamantitipan">
<div id="ft06_pinjamantitipangrid" class="ewForm ewListForm form-inline">
...
<?php if ($t06_pinjamantitipan->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t06_pinjamantitipan->id->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_id" class="t06_pinjamantitipan_id">
...
<?php if ($t06_pinjamantitipan->pinjaman_id->Visible) { // pinjaman_id ?>
	...
	<?php } else { ?>
		<th data-name="pinjaman_id" class="<?php echo $t06_pinjamantitipan->pinjaman_id->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_pinjaman_id" class="t06_pinjamantitipan_pinjaman_id">
...
<?php if ($t06_pinjamantitipan->Tanggal->Visible) { // Tanggal ?>
	...
	<?php } else { ?>
		<th data-name="Tanggal" class="<?php echo $t06_pinjamantitipan->Tanggal->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_Tanggal" class="t06_pinjamantitipan_Tanggal">
...
<?php if ($t06_pinjamantitipan->Keterangan->Visible) { // Keterangan ?>
	...
	<?php } else { ?>
		<th data-name="Keterangan" class="<?php echo $t06_pinjamantitipan->Keterangan->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_Keterangan" class="t06_pinjamantitipan_Keterangan">
...
<?php if ($t06_pinjamantitipan->Masuk->Visible) { // Masuk ?>
	...
	<?php } else { ?>
		<th data-name="Masuk" class="<?php echo $t06_pinjamantitipan->Masuk->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_Masuk" class="t06_pinjamantitipan_Masuk">
...
<?php if ($t06_pinjamantitipan->Keluar->Visible) { // Keluar ?>
	...
	<?php } else { ?>
		<th data-name="Keluar" class="<?php echo $t06_pinjamantitipan->Keluar->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_Keluar" class="t06_pinjamantitipan_Keluar">
...
<?php if ($t06_pinjamantitipan->Sisa->Visible) { // Sisa ?>
	...
	<?php } else { ?>
		<th data-name="Sisa" class="<?php echo $t06_pinjamantitipan->Sisa->HeaderCellClass() ?>"><div><div id="elh_t06_pinjamantitipan_Sisa" class="t06_pinjamantitipan_Sisa">
	...
	if (intval($t06_pinjamantitipan_grid->RecCnt) >= intval($t06_pinjamantitipan_grid->StartRec)) {
		...
		if ($t06_pinjamantitipan->CurrentAction == "gridadd") {
			if ($t06_pinjamantitipan->CurrentMode == "copy") {
				...
				$t06_pinjamantitipan_grid->LoadRowValues(); // Load default values
...
<?php
	if ($t06_pinjamantitipan->CurrentMode == "add" || $t06_pinjamantitipan->CurrentMode == "copy" || $t06_pinjamantitipan->CurrentMode == "edit") {
		...
		$t06_pinjamantitipan_grid->LoadRowValues();
...
// Render list options (body, right)
$t06_pinjamantitipan_grid->ListOptions->Render("body", "right", $t06_pinjamantitipan_grid->RowIndex);
?>
<script type="text/javascript">
ft06_pinjamantitipangrid.UpdateOpts(<?php echo $t06_pinjamantitipan_grid->RowIndex ?>);
</script>
