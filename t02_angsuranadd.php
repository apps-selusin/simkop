...
<?php if ($t02_angsuran->NoKontrak->Visible) { // NoKontrak ?>
	<div id="r_NoKontrak" class="form-group">
		<label id="elh_t02_angsuran_NoKontrak" for="x_NoKontrak" class="<?php echo $t02_angsuran_add->LeftColumnClass ?>"><?php echo $t02_angsuran->NoKontrak->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t02_angsuran_add->RightColumnClass ?>"><div<?php echo $t02_angsuran->NoKontrak->CellAttributes() ?>>
