...
define("EW_PROJECT_NAME", "simkop_prj", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'YS0fYArOectxuR0i', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_simkop", "qs" => "`", "qe" => "`");
