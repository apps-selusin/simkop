...
ft99_audittrailview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($t99_audittrail_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t99_audittrail->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_t99_audittrail_id"><?php echo $t99_audittrail->id->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->datetime->Visible) { // datetime ?>
	<tr id="r_datetime">
		<td class="col-sm-2"><span id="elh_t99_audittrail_datetime"><?php echo $t99_audittrail->datetime->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->script->Visible) { // script ?>
	<tr id="r_script">
		<td class="col-sm-2"><span id="elh_t99_audittrail_script"><?php echo $t99_audittrail->script->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->user->Visible) { // user ?>
	<tr id="r_user">
		<td class="col-sm-2"><span id="elh_t99_audittrail_user"><?php echo $t99_audittrail->user->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->action->Visible) { // action ?>
	<tr id="r_action">
		<td class="col-sm-2"><span id="elh_t99_audittrail_action"><?php echo $t99_audittrail->action->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->_table->Visible) { // table ?>
	<tr id="r__table">
		<td class="col-sm-2"><span id="elh_t99_audittrail__table"><?php echo $t99_audittrail->_table->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->_field->Visible) { // field ?>
	<tr id="r__field">
		<td class="col-sm-2"><span id="elh_t99_audittrail__field"><?php echo $t99_audittrail->_field->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->keyvalue->Visible) { // keyvalue ?>
	<tr id="r_keyvalue">
		<td class="col-sm-2"><span id="elh_t99_audittrail_keyvalue"><?php echo $t99_audittrail->keyvalue->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->oldvalue->Visible) { // oldvalue ?>
	<tr id="r_oldvalue">
		<td class="col-sm-2"><span id="elh_t99_audittrail_oldvalue"><?php echo $t99_audittrail->oldvalue->FldCaption() ?></span></td>
...
<?php if ($t99_audittrail->newvalue->Visible) { // newvalue ?>
	<tr id="r_newvalue">
		<td class="col-sm-2"><span id="elh_t99_audittrail_newvalue"><?php echo $t99_audittrail->newvalue->FldCaption() ?></span></td>
