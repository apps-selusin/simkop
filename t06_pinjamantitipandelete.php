...
$t06_pinjamantitipan_delete = NULL; // Initialize page object first

class ct06_pinjamantitipan_delete extends ct06_pinjamantitipan {
	...
	// Page object name
	var $PageObjName = 't06_pinjamantitipan_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t06_pinjamantitipanlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t06_pinjamantitipan class, t06_pinjamantitipaninfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t06_pinjamantitipanlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t06_pinjamantitipan_delete)) $t06_pinjamantitipan_delete = new ct06_pinjamantitipan_delete();

// Page init
$t06_pinjamantitipan_delete->Page_Init();

// Page main
$t06_pinjamantitipan_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_pinjamantitipan_delete->Page_Render();
?>
...
var CurrentForm = ft06_pinjamantitipandelete = new ew_Form("ft06_pinjamantitipandelete", "delete");

// Form_CustomValidate event
ft06_pinjamantitipandelete.Form_CustomValidate = 
...
ft06_pinjamantitipandelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t06_pinjamantitipan_delete->ShowPageHeader(); ?>
<?php
$t06_pinjamantitipan_delete->ShowMessage();
?>
<form name="ft06_pinjamantitipandelete" id="ft06_pinjamantitipandelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_pinjamantitipan_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_pinjamantitipan_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t06_pinjamantitipan">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t06_pinjamantitipan_delete->RecKeys as $key) { ?>
...
<?php if ($t06_pinjamantitipan->Keterangan->Visible) { // Keterangan ?>
		<th class="<?php echo $t06_pinjamantitipan->Keterangan->HeaderCellClass() ?>"><span id="elh_t06_pinjamantitipan_Keterangan" class="t06_pinjamantitipan_Keterangan"><?php echo $t06_pinjamantitipan->Keterangan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t06_pinjamantitipan->Masuk->Visible) { // Masuk ?>
		<th class="<?php echo $t06_pinjamantitipan->Masuk->HeaderCellClass() ?>"><span id="elh_t06_pinjamantitipan_Masuk" class="t06_pinjamantitipan_Masuk"><?php echo $t06_pinjamantitipan->Masuk->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t06_pinjamantitipan->Keluar->Visible) { // Keluar ?>
		<th class="<?php echo $t06_pinjamantitipan->Keluar->HeaderCellClass() ?>"><span id="elh_t06_pinjamantitipan_Keluar" class="t06_pinjamantitipan_Keluar"><?php echo $t06_pinjamantitipan->Keluar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t06_pinjamantitipan->Sisa->Visible) { // Sisa ?>
		<th class="<?php echo $t06_pinjamantitipan->Sisa->HeaderCellClass() ?>"><span id="elh_t06_pinjamantitipan_Sisa" class="t06_pinjamantitipan_Sisa"><?php echo $t06_pinjamantitipan->Sisa->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t06_pinjamantitipan_delete->RecCnt = 0;
$i = 0;
while (!$t06_pinjamantitipan_delete->Recordset->EOF) {
	$t06_pinjamantitipan_delete->RecCnt++;
	$t06_pinjamantitipan_delete->RowCnt++;

	// Set row properties
	$t06_pinjamantitipan->ResetAttrs();
	$t06_pinjamantitipan->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t06_pinjamantitipan_delete->LoadRowValues($t06_pinjamantitipan_delete->Recordset);
...
<?php } ?>
<?php if ($t06_pinjamantitipan->Masuk->Visible) { // Masuk ?>
		<td<?php echo $t06_pinjamantitipan->Masuk->CellAttributes() ?>>
<span id="el<?php echo $t06_pinjamantitipan_delete->RowCnt ?>_t06_pinjamantitipan_Masuk" class="t06_pinjamantitipan_Masuk">
...
<?php } ?>
<?php if ($t06_pinjamantitipan->Keluar->Visible) { // Keluar ?>
		<td<?php echo $t06_pinjamantitipan->Keluar->CellAttributes() ?>>
<span id="el<?php echo $t06_pinjamantitipan_delete->RowCnt ?>_t06_pinjamantitipan_Keluar" class="t06_pinjamantitipan_Keluar">
...
<?php } ?>
<?php if ($t06_pinjamantitipan->Sisa->Visible) { // Sisa ?>
		<td<?php echo $t06_pinjamantitipan->Sisa->CellAttributes() ?>>
...
<?php
	$t06_pinjamantitipan_delete->Recordset->MoveNext();
}
$t06_pinjamantitipan_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t06_pinjamantitipan_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft06_pinjamantitipandelete.Init();
</script>
<?php
$t06_pinjamantitipan_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_pinjamantitipan_delete->Page_Terminate();
?>
