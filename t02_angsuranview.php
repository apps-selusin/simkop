...
$t02_angsuran_view = NULL; // Initialize page object first

class ct02_angsuran_view extends ct02_angsuran {
	...
	// Page object name
	var $PageObjName = 't02_angsuran_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t02_angsuranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t02_angsuranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t02_angsuranlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t02_angsuran_view)) $t02_angsuran_view = new ct02_angsuran_view();

// Page init
$t02_angsuran_view->Page_Init();

// Page main
$t02_angsuran_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t02_angsuran_view->Page_Render();
?>
...
var CurrentForm = ft02_angsuranview = new ew_Form("ft02_angsuranview", "view");

// Form_CustomValidate event
ft02_angsuranview.Form_CustomValidate = 
...
ft02_angsuranview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $t02_angsuran_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t02_angsuran_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $t02_angsuran_view->ShowPageHeader(); ?>
<?php
$t02_angsuran_view->ShowMessage();
?>
<form name="ft02_angsuranview" id="ft02_angsuranview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t02_angsuran_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t02_angsuran_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t02_angsuran">
<input type="hidden" name="modal" value="<?php echo intval($t02_angsuran_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t02_angsuran->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_t02_angsuran_id"><?php echo $t02_angsuran->id->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->nasabah_id->Visible) { // nasabah_id ?>
	<tr id="r_nasabah_id">
		<td class="col-sm-2"><span id="elh_t02_angsuran_nasabah_id"><?php echo $t02_angsuran->nasabah_id->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->nasabah_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->Tanggal->Visible) { // Tanggal ?>
	<tr id="r_Tanggal">
		<td class="col-sm-2"><span id="elh_t02_angsuran_Tanggal"><?php echo $t02_angsuran->Tanggal->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->AngsuranPokok->Visible) { // AngsuranPokok ?>
	<tr id="r_AngsuranPokok">
		<td class="col-sm-2"><span id="elh_t02_angsuran_AngsuranPokok"><?php echo $t02_angsuran->AngsuranPokok->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->AngsuranPokok->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->AngsuranBunga->Visible) { // AngsuranBunga ?>
	<tr id="r_AngsuranBunga">
		<td class="col-sm-2"><span id="elh_t02_angsuran_AngsuranBunga"><?php echo $t02_angsuran->AngsuranBunga->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->AngsuranBunga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->AngsuranTotal->Visible) { // AngsuranTotal ?>
	<tr id="r_AngsuranTotal">
		<td class="col-sm-2"><span id="elh_t02_angsuran_AngsuranTotal"><?php echo $t02_angsuran->AngsuranTotal->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->AngsuranTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->SisaHutang->Visible) { // SisaHutang ?>
	<tr id="r_SisaHutang">
		<td class="col-sm-2"><span id="elh_t02_angsuran_SisaHutang"><?php echo $t02_angsuran->SisaHutang->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->SisaHutang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->TanggalBayar->Visible) { // TanggalBayar ?>
	<tr id="r_TanggalBayar">
		<td class="col-sm-2"><span id="elh_t02_angsuran_TanggalBayar"><?php echo $t02_angsuran->TanggalBayar->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->TanggalBayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->TotalDenda->Visible) { // TotalDenda ?>
	<tr id="r_TotalDenda">
		<td class="col-sm-2"><span id="elh_t02_angsuran_TotalDenda"><?php echo $t02_angsuran->TotalDenda->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->TotalDenda->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->Terlambat->Visible) { // Terlambat ?>
	<tr id="r_Terlambat">
		<td class="col-sm-2"><span id="elh_t02_angsuran_Terlambat"><?php echo $t02_angsuran->Terlambat->FldCaption() ?></span></td>
...
<?php echo $t02_angsuran->Terlambat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_angsuran->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td class="col-sm-2"><span id="elh_t02_angsuran_Keterangan"><?php echo $t02_angsuran->Keterangan->FldCaption() ?></span></td>
		<td data-name="Keterangan"<?php echo $t02_angsuran->Keterangan->CellAttributes() ?>>
<span id="el_t02_angsuran_Keterangan">
<span<?php echo $t02_angsuran->Keterangan->ViewAttributes() ?>>
<?php echo $t02_angsuran->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft02_angsuranview.Init();
</script>
<?php
$t02_angsuran_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t02_angsuran_view->Page_Terminate();
?>
