...
class cchangepwd extends ct96_employees {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t96_employees"])) $GLOBALS["t96_employees"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't96_employees');
		}
