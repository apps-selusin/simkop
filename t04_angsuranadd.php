...
<?php if (strval($t04_angsuran->pinjaman_id->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_pinjaman_id" id="x_pinjaman_id" value="<?php echo ew_HtmlEncode(strval($t04_angsuran->pinjaman_id->getSessionValue())) ?>">
<?php } ?>
