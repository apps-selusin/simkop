...
$t06_pinjamantitipan_view = NULL; // Initialize page object first

class ct06_pinjamantitipan_view extends ct06_pinjamantitipan {
	...
	// Page object name
	var $PageObjName = 't06_pinjamantitipan_view';
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t06_pinjamantitipanlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "t06_pinjamantitipanlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t06_pinjamantitipan_view)) $t06_pinjamantitipan_view = new ct06_pinjamantitipan_view();

// Page init
$t06_pinjamantitipan_view->Page_Init();

// Page main
$t06_pinjamantitipan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_pinjamantitipan_view->Page_Render();
?>
...
var CurrentForm = ft06_pinjamantitipanview = new ew_Form("ft06_pinjamantitipanview", "view");

// Form_CustomValidate event
ft06_pinjamantitipanview.Form_CustomValidate = 
...
ft06_pinjamantitipanview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $t06_pinjamantitipan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t06_pinjamantitipan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $t06_pinjamantitipan_view->ShowPageHeader(); ?>
<?php
$t06_pinjamantitipan_view->ShowMessage();
?>
<?php if (!$t06_pinjamantitipan_view->IsModal) { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t06_pinjamantitipan_view->Pager)) $t06_pinjamantitipan_view->Pager = new cPrevNextPager($t06_pinjamantitipan_view->StartRec, $t06_pinjamantitipan_view->DisplayRecs, $t06_pinjamantitipan_view->TotalRecs, $t06_pinjamantitipan_view->AutoHidePager) ?>
<?php if ($t06_pinjamantitipan_view->Pager->RecordCount > 0 && $t06_pinjamantitipan_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t06_pinjamantitipan_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t06_pinjamantitipan_view->PageUrl() ?>start=<?php echo $t06_pinjamantitipan_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t06_pinjamantitipan_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t06_pinjamantitipan_view->PageUrl() ?>start=<?php echo $t06_pinjamantitipan_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t06_pinjamantitipan_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t06_pinjamantitipan_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t06_pinjamantitipan_view->PageUrl() ?>start=<?php echo $t06_pinjamantitipan_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t06_pinjamantitipan_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t06_pinjamantitipan_view->PageUrl() ?>start=<?php echo $t06_pinjamantitipan_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t06_pinjamantitipan_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft06_pinjamantitipanview" id="ft06_pinjamantitipanview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_pinjamantitipan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_pinjamantitipan_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t06_pinjamantitipan">
<input type="hidden" name="modal" value="<?php echo intval($t06_pinjamantitipan_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t06_pinjamantitipan->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_id"><?php echo $t06_pinjamantitipan->id->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->pinjaman_id->Visible) { // pinjaman_id ?>
	<tr id="r_pinjaman_id">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_pinjaman_id"><?php echo $t06_pinjamantitipan->pinjaman_id->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->pinjaman_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->Tanggal->Visible) { // Tanggal ?>
	<tr id="r_Tanggal">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_Tanggal"><?php echo $t06_pinjamantitipan->Tanggal->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_Keterangan"><?php echo $t06_pinjamantitipan->Keterangan->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->Masuk->Visible) { // Masuk ?>
	<tr id="r_Masuk">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_Masuk"><?php echo $t06_pinjamantitipan->Masuk->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->Masuk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->Keluar->Visible) { // Keluar ?>
	<tr id="r_Keluar">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_Keluar"><?php echo $t06_pinjamantitipan->Keluar->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->Keluar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_pinjamantitipan->Sisa->Visible) { // Sisa ?>
	<tr id="r_Sisa">
		<td class="col-sm-2"><span id="elh_t06_pinjamantitipan_Sisa"><?php echo $t06_pinjamantitipan->Sisa->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->Sisa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft06_pinjamantitipanview.Init();
</script>
<?php
$t06_pinjamantitipan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_pinjamantitipan_view->Page_Terminate();
?>
