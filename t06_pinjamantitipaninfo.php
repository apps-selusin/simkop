...
$t06_pinjamantitipan = NULL;

//
// Table class for t06_pinjamantitipan
//
class ct06_pinjamantitipan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't06_pinjamantitipan';
		$this->TableName = 't06_pinjamantitipan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t06_pinjamantitipan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// pinjaman_id
		$this->pinjaman_id = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_pinjaman_id', 'pinjaman_id', '`pinjaman_id`', '`pinjaman_id`', 3, -1, FALSE, '`pinjaman_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Keterangan
		$this->Keterangan = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Masuk
		$this->Masuk = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_Masuk', 'Masuk', '`Masuk`', '`Masuk`', 4, -1, FALSE, '`Masuk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Masuk->Sortable = TRUE; // Allow sort
		$this->Masuk->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Masuk'] = &$this->Masuk;

		// Keluar
		$this->Keluar = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_Keluar', 'Keluar', '`Keluar`', '`Keluar`', 4, -1, FALSE, '`Keluar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Keluar->Sortable = TRUE; // Allow sort
		$this->Keluar->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Keluar'] = &$this->Keluar;

		// Sisa
		$this->Sisa = new cField('t06_pinjamantitipan', 't06_pinjamantitipan', 'x_Sisa', 'Sisa', '`Sisa`', '`Sisa`', 4, -1, FALSE, '`Sisa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t06_pinjamantitipan`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t06_pinjamantitipanlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t06_pinjamantitipanedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t06_pinjamantitipanadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t06_pinjamantitipanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t06_pinjamantitipanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t06_pinjamantitipanadd.php?" . $this->UrlParm($parm);
		else
			$url = "t06_pinjamantitipanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t06_pinjamantitipanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t06_pinjamantitipanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t06_pinjamantitipandelete.php", $this->UrlParm());
	}
