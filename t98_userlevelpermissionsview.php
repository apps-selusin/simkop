...
ft98_userlevelpermissionsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($t98_userlevelpermissions_view->Pager)) $t98_userlevelpermissions_view->Pager = new cPrevNextPager($t98_userlevelpermissions_view->StartRec, $t98_userlevelpermissions_view->DisplayRecs, $t98_userlevelpermissions_view->TotalRecs, $t98_userlevelpermissions_view->AutoHidePager) ?>
...
<input type="hidden" name="modal" value="<?php echo intval($t98_userlevelpermissions_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t98_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td class="col-sm-2"><span id="elh_t98_userlevelpermissions_userlevelid"><?php echo $t98_userlevelpermissions->userlevelid->FldCaption() ?></span></td>
...
<?php if ($t98_userlevelpermissions->_tablename->Visible) { // tablename ?>
	<tr id="r__tablename">
		<td class="col-sm-2"><span id="elh_t98_userlevelpermissions__tablename"><?php echo $t98_userlevelpermissions->_tablename->FldCaption() ?></span></td>
...
<?php if ($t98_userlevelpermissions->permission->Visible) { // permission ?>
	<tr id="r_permission">
		<td class="col-sm-2"><span id="elh_t98_userlevelpermissions_permission"><?php echo $t98_userlevelpermissions->permission->FldCaption() ?></span></td>
