...
ft04_angsuranedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($t04_angsuran_edit->IsModal) ?>">
...
<?php if ($t04_angsuran->AngsuranKe->Visible) { // AngsuranKe ?>
	<div id="r_AngsuranKe" class="form-group">
		...
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->AngsuranKe->CellAttributes() ?>>
...
<?php if ($t04_angsuran->AngsuranTanggal->Visible) { // AngsuranTanggal ?>
	<div id="r_AngsuranTanggal" class="form-group">
		<label id="elh_t04_angsuran_AngsuranTanggal" for="x_AngsuranTanggal" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->AngsuranTanggal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->AngsuranTanggal->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ft04_angsuranedit", "x_AngsuranTanggal", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($t04_angsuran->AngsuranPokok->Visible) { // AngsuranPokok ?>
	<div id="r_AngsuranPokok" class="form-group">
		<label id="elh_t04_angsuran_AngsuranPokok" for="x_AngsuranPokok" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->AngsuranPokok->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->AngsuranPokok->CellAttributes() ?>>
...
<?php if ($t04_angsuran->AngsuranBunga->Visible) { // AngsuranBunga ?>
	<div id="r_AngsuranBunga" class="form-group">
		<label id="elh_t04_angsuran_AngsuranBunga" for="x_AngsuranBunga" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->AngsuranBunga->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->AngsuranBunga->CellAttributes() ?>>
...
<?php if ($t04_angsuran->AngsuranTotal->Visible) { // AngsuranTotal ?>
	<div id="r_AngsuranTotal" class="form-group">
		<label id="elh_t04_angsuran_AngsuranTotal" for="x_AngsuranTotal" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->AngsuranTotal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->AngsuranTotal->CellAttributes() ?>>
...
<?php if ($t04_angsuran->SisaHutang->Visible) { // SisaHutang ?>
	<div id="r_SisaHutang" class="form-group">
		<label id="elh_t04_angsuran_SisaHutang" for="x_SisaHutang" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->SisaHutang->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->SisaHutang->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ft04_angsuranedit", "x_TanggalBayar", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($t04_angsuran->TotalDenda->Visible) { // TotalDenda ?>
	<div id="r_TotalDenda" class="form-group">
		<label id="elh_t04_angsuran_TotalDenda" for="x_TotalDenda" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->TotalDenda->FldCaption() ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->TotalDenda->CellAttributes() ?>>
...
<?php if ($t04_angsuran->Terlambat->Visible) { // Terlambat ?>
	<div id="r_Terlambat" class="form-group">
		<label id="elh_t04_angsuran_Terlambat" for="x_Terlambat" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->Terlambat->FldCaption() ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->Terlambat->CellAttributes() ?>>
...
<?php if ($t04_angsuran->Keterangan->Visible) { // Keterangan ?>
	<div id="r_Keterangan" class="form-group">
		<label id="elh_t04_angsuran_Keterangan" for="x_Keterangan" class="<?php echo $t04_angsuran_edit->LeftColumnClass ?>"><?php echo $t04_angsuran->Keterangan->FldCaption() ?></label>
		<div class="<?php echo $t04_angsuran_edit->RightColumnClass ?>"><div<?php echo $t04_angsuran->Keterangan->CellAttributes() ?>>
