...
class ct98_userlevelpermissions_edit extends ct98_userlevelpermissions {
		...
		if ($url <> "") {
			...
			if ($this->IsModal) { // Show as modal
				...
				if ($pageName != $this->GetListUrl()) { // Not List page
					...
					if ($pageName == "t98_userlevelpermissionsview.php")
						$row["view"] = "1";
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			if (!is_null($this->userlevelid->CurrentValue) && !is_null($this->_tablename->CurrentValue)) {
...
ft98_userlevelpermissionsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($t98_userlevelpermissions_edit->Pager)) $t98_userlevelpermissions_edit->Pager = new cPrevNextPager($t98_userlevelpermissions_edit->StartRec, $t98_userlevelpermissions_edit->DisplayRecs, $t98_userlevelpermissions_edit->TotalRecs, $t98_userlevelpermissions_edit->AutoHidePager) ?>
...
<input type="hidden" name="modal" value="<?php echo intval($t98_userlevelpermissions_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($t98_userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<div id="r_userlevelid" class="form-group">
		<label id="elh_t98_userlevelpermissions_userlevelid" for="x_userlevelid" class="<?php echo $t98_userlevelpermissions_edit->LeftColumnClass ?>"><?php echo $t98_userlevelpermissions->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t98_userlevelpermissions_edit->RightColumnClass ?>"><div<?php echo $t98_userlevelpermissions->userlevelid->CellAttributes() ?>>
...
<?php if ($t98_userlevelpermissions->_tablename->Visible) { // tablename ?>
	<div id="r__tablename" class="form-group">
		<label id="elh_t98_userlevelpermissions__tablename" for="x__tablename" class="<?php echo $t98_userlevelpermissions_edit->LeftColumnClass ?>"><?php echo $t98_userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t98_userlevelpermissions_edit->RightColumnClass ?>"><div<?php echo $t98_userlevelpermissions->_tablename->CellAttributes() ?>>
...
<?php if ($t98_userlevelpermissions->permission->Visible) { // permission ?>
	<div id="r_permission" class="form-group">
		<label id="elh_t98_userlevelpermissions_permission" for="x_permission" class="<?php echo $t98_userlevelpermissions_edit->LeftColumnClass ?>"><?php echo $t98_userlevelpermissions->permission->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t98_userlevelpermissions_edit->RightColumnClass ?>"><div<?php echo $t98_userlevelpermissions->permission->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t98_userlevelpermissions_edit->OffsetColumnClass ?>"><!-- buttons offset -->
