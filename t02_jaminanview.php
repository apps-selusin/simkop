...
ft02_jaminanview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if (!isset($t02_jaminan_view->Pager)) $t02_jaminan_view->Pager = new cPrevNextPager($t02_jaminan_view->StartRec, $t02_jaminan_view->DisplayRecs, $t02_jaminan_view->TotalRecs, $t02_jaminan_view->AutoHidePager) ?>
<?php if ($t02_jaminan_view->Pager->RecordCount > 0 && $t02_jaminan_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t02_jaminan_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t02_jaminan_view->PageUrl() ?>start=<?php echo $t02_jaminan_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t02_jaminan_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t02_jaminan_view->PageUrl() ?>start=<?php echo $t02_jaminan_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t02_jaminan_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t02_jaminan_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t02_jaminan_view->PageUrl() ?>start=<?php echo $t02_jaminan_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t02_jaminan_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t02_jaminan_view->PageUrl() ?>start=<?php echo $t02_jaminan_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t02_jaminan_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<input type="hidden" name="modal" value="<?php echo intval($t02_jaminan_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t02_jaminan->nasabah_id->Visible) { // nasabah_id ?>
	<tr id="r_nasabah_id">
		<td class="col-sm-2"><span id="elh_t02_jaminan_nasabah_id"><?php echo $t02_jaminan->nasabah_id->FldCaption() ?></span></td>
...
<?php if ($t02_jaminan->MerkType->Visible) { // MerkType ?>
	<tr id="r_MerkType">
		<td class="col-sm-2"><span id="elh_t02_jaminan_MerkType"><?php echo $t02_jaminan->MerkType->FldCaption() ?></span></td>
...
<?php echo $t02_jaminan->MerkType->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_jaminan->NoRangka->Visible) { // NoRangka ?>
	<tr id="r_NoRangka">
		<td class="col-sm-2"><span id="elh_t02_jaminan_NoRangka"><?php echo $t02_jaminan->NoRangka->FldCaption() ?></span></td>
...
<?php echo $t02_jaminan->NoRangka->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_jaminan->NoMesin->Visible) { // NoMesin ?>
	<tr id="r_NoMesin">
		<td class="col-sm-2"><span id="elh_t02_jaminan_NoMesin"><?php echo $t02_jaminan->NoMesin->FldCaption() ?></span></td>
...
<?php echo $t02_jaminan->NoMesin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_jaminan->Warna->Visible) { // Warna ?>
	<tr id="r_Warna">
		<td class="col-sm-2"><span id="elh_t02_jaminan_Warna"><?php echo $t02_jaminan->Warna->FldCaption() ?></span></td>
...
<?php if ($t02_jaminan->NoPol->Visible) { // NoPol ?>
	<tr id="r_NoPol">
		<td class="col-sm-2"><span id="elh_t02_jaminan_NoPol"><?php echo $t02_jaminan->NoPol->FldCaption() ?></span></td>
...
<?php echo $t02_jaminan->NoPol->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t02_jaminan->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td class="col-sm-2"><span id="elh_t02_jaminan_Keterangan"><?php echo $t02_jaminan->Keterangan->FldCaption() ?></span></td>
...
<?php if ($t02_jaminan->AtasNama->Visible) { // AtasNama ?>
	<tr id="r_AtasNama">
		<td class="col-sm-2"><span id="elh_t02_jaminan_AtasNama"><?php echo $t02_jaminan->AtasNama->FldCaption() ?></span></td>
...
<?php echo $t02_jaminan->AtasNama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
