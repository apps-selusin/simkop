...
$t99_audittrail_add = NULL; // Initialize page object first

class ct99_audittrail_add extends ct99_audittrail {
	...
	// Page object name
	var $PageObjName = 't99_audittrail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t99_audittrailview.php")
	...
	function NewRow() {
		...
		$row['field'] = $this->_field->CurrentValue;
...
// Create page object
if (!isset($t99_audittrail_add)) $t99_audittrail_add = new ct99_audittrail_add();

// Page init
$t99_audittrail_add->Page_Init();

// Page main
$t99_audittrail_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t99_audittrail_add->Page_Render();
?>
...
var CurrentForm = ft99_audittrailadd = new ew_Form("ft99_audittrailadd", "add");

// Validate form
ft99_audittrailadd.Validate = function() {
...
ft99_audittrailadd.Form_CustomValidate = 
...
ft99_audittrailadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t99_audittrail_add->ShowPageHeader(); ?>
<?php
$t99_audittrail_add->ShowMessage();
?>
<form name="ft99_audittrailadd" id="ft99_audittrailadd" class="<?php echo $t99_audittrail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t99_audittrail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t99_audittrail_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t99_audittrail">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t99_audittrail_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t99_audittrail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_t99_audittrail_datetime" for="x_datetime" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->datetime->CellAttributes() ?>>
...
<?php if ($t99_audittrail->script->Visible) { // script ?>
	<div id="r_script" class="form-group">
		<label id="elh_t99_audittrail_script" for="x_script" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->script->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->script->CellAttributes() ?>>
...
<?php if ($t99_audittrail->user->Visible) { // user ?>
	<div id="r_user" class="form-group">
		<label id="elh_t99_audittrail_user" for="x_user" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->user->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->user->CellAttributes() ?>>
...
<?php if ($t99_audittrail->action->Visible) { // action ?>
	<div id="r_action" class="form-group">
		<label id="elh_t99_audittrail_action" for="x_action" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->action->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->action->CellAttributes() ?>>
...
<?php if ($t99_audittrail->_table->Visible) { // table ?>
	<div id="r__table" class="form-group">
		<label id="elh_t99_audittrail__table" for="x__table" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->_table->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->_table->CellAttributes() ?>>
...
<?php if ($t99_audittrail->_field->Visible) { // field ?>
	<div id="r__field" class="form-group">
		<label id="elh_t99_audittrail__field" for="x__field" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->_field->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->_field->CellAttributes() ?>>
...
<?php if ($t99_audittrail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group">
		<label id="elh_t99_audittrail_keyvalue" for="x_keyvalue" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->keyvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->keyvalue->CellAttributes() ?>>
...
<?php if ($t99_audittrail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group">
		<label id="elh_t99_audittrail_oldvalue" for="x_oldvalue" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->oldvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->oldvalue->CellAttributes() ?>>
...
<?php if ($t99_audittrail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group">
		<label id="elh_t99_audittrail_newvalue" for="x_newvalue" class="<?php echo $t99_audittrail_add->LeftColumnClass ?>"><?php echo $t99_audittrail->newvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audittrail_add->RightColumnClass ?>"><div<?php echo $t99_audittrail->newvalue->CellAttributes() ?>>
...
<?php if (!$t99_audittrail_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t99_audittrail_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t99_audittrail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ft99_audittrailadd.Init();
</script>
<?php
$t99_audittrail_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t99_audittrail_add->Page_Terminate();
?>
